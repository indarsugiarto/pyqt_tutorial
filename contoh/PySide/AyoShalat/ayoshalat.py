...
from PyQt5.QtWidgets import QDialog, QFrame, QMainWindow, QMenu, QPushButton, QSystemTrayIcon
...
class AyoShalat(QMainWindow):
    ...
    def __init__(self):
        ...
        self.default_azan = self.current_directory + '/audio/azan.wav'
        self.default_notif = self.current_directory + '/audio/hayyalashala.wav'
