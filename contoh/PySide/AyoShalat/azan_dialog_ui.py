...
################################################################################
## Form generated from reading UI file 'azan_dialog.ui'
##
...
class Ui_AzanDialog(object):
    def setupUi(self, AzanDialog):
        ...
        QMetaObject.connectSlotsByName(AzanDialog)
    # setupUi

    def retranslateUi(self, AzanDialog):
        AzanDialog.setWindowTitle(QCoreApplication.translate("AzanDialog", u"Form", None))
    # retranslateUi
